...
<form class="tab" action="$blog->home?action=entry_create_post" method="POST">
...
<section id="tab-section-setting">
  ...
  <tr>
    <th>記事の公開</th>
    <td><select name="open"><option value="公開" selected>公開する</option><option value="非公開">非公開にする</option></select></td>
  </tr>
  </table>
</section>
